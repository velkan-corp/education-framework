...
<h2 id="s-rejection"><span class="material-symbols-rounded">visibility</span>Risk 2: The Child Rejects the Framework</h2>
...
<h2 id="s-parent"><span class="material-symbols-rounded">self_improvement</span>Parent Self-Development</h2>
<p>The parent is the primary instrument. Every principle in this framework is transmitted through parental behavior, not instruction. An exhausted, resentful, intellectually stagnant parent cannot model joy, curiosity, kindness, or resilience — no matter how good the curriculum. Maintaining the instrument is not self-indulgent; it is structurally necessary.</p>

<h3>Intellectual Life</h3>
<p><strong>Read.</strong> Not parenting books — real books. History, science, philosophy, literature. A parent who is visibly reading, visibly curious, visibly excited about an idea models Deep Curiosity (Target 4) more powerfully than any activity in this framework. "The child who sees their parent reading will read. The child who is told to read by a parent watching television will not."</p>
<p><strong>Learn something new.</strong> Take a class, pick up an instrument, start a language. The struggle-learn-grow cycle must be visible. A parent learning to play guitar badly is a more powerful lesson in resilience than any motivational speech.</p>

<h3>Physical System</h3>
<p><strong>Exercise.</strong> The same evidence that applies to children applies to parents: 30 minutes of cardio improves cognitive function, emotional regulation, and sleep quality. You cannot model Physical System Mastery (Target 9) from the couch.</p>
<p><strong>Sleep.</strong> Parental sleep deprivation is the single most common cause of household irritability, impaired judgment, and reduced patience — all of which degrade every interaction in the framework. Protect your own sleep with the same non-negotiable stance you apply to the children's.</p>

<h3>Emotional Regulation</h3>
<p><strong>You are the child's regulation system.</strong> When you lose your temper, the framework loses credibility. When you stay calm under pressure, you model Self-Awareness & Self-Regulation (Target 3) live. This is not about being perfect — it is about being honest. "I got angry. That wasn't the right response. Here's what I should have done." Modelling recovery is as valuable as modelling regulation.</p>
<p><strong>Marriage/partnership health.</strong> The quality of the parental relationship is the emotional weather system of the household. A child in a home with chronic parental conflict absorbs anxiety regardless of how excellent the curriculum is. Invest in the relationship: date nights, honest communication, shared projects, couples therapy when needed. The co-parenting section describes roles; this section says: the relationship itself requires maintenance.</p>

<h3>Burnout Prevention</h3>
<p><strong>The framework is dense by design.</strong> It is also exhausting if you try to execute everything simultaneously. Use the tier system: Tier 1 (Foundational) is non-negotiable. Tier 2 (Core) adapts. Tier 3 (Recommended) is released guilt-free. A parent running at 100% for 18 years will burn out by year 5. Sustainable intensity beats unsustainable perfection.</p>
<p><strong>Take breaks from the framework.</strong> Some weekends should have zero educational agenda. Not every meal needs a Socratic question. Not every outing needs a learning objective. The parent who can turn it off demonstrates something the framework cannot teach: that life is more than optimisation.</p>
...
<tr><td>1–3</td><td>11–14</td><td>One nap transitioning to none. Bedtime ritual is sacred.</td></tr>
<tr><td>4–7</td><td>10–13</td><td>No screens 1 hour before bed. Dark room. Cool temperature.</td></tr>
<tr><td>8–13</td><td>9–11</td><td>By 11, they should understand sleep architecture. Bedtime is self-managed but non-negotiable.</td></tr>
<tr><td>14–18</td><td>8–10</td><td>Sleep before 11pm on school nights. They will resist. The evidence is unambiguous: sleep-deprived teenagers perform like impaired adults.</td></tr>
</table>
<h3>Nutrition</h3>
<p>Not a diet program. Three principles: minimize processed sugar (the dose makes the poison), no caffeine before 16 (it disrupts the developing sleep system), whole foods emphasis as the default rather than the exception. The goal is a child who understands that food is fuel and that fuel quality affects performance — not a child with an anxious relationship with food.</p>
<h3>Recovery</h3>
<p>Rest days from intensive practice. Deload weeks from heavy cognitive or physical schedules. The brain consolidates learning during rest, not during practice — the practice provides the signal, rest provides the integration. A child who practices piano 7 days a week will plateau faster than one who practices 5 and rests 2. This applies to every domain in the framework. Build recovery into the schedule explicitly, or it won't happen.</p>

<h2 id="s-fun"><span class="material-symbols-rounded">theaters</span>Pop Culture & Fun</h2>
<p>Life needs play, absurdity, and shared cultural vocabulary. The framework is austere by design — this section counterbalances.</p>
<p><strong>Principle:</strong> Pop culture as social currency and recovery, not curriculum. They need enough shared cultural knowledge to participate in peer conversations without being aliens. They need downtime that isn't productive.</p>
...
<p>• Daily outdoor time minimum (1.5 hours, regardless of weather).<br>
• Let them struggle — wait 90 seconds before helping with any task they're attempting.<br>
• Spanish reading list (3 books/day for toddlers, 1 chapter/day for older).<br>
• Meal/nap schedule (consistent times).<br>
• Screen rules (none before 3; specific budget after).<br>
• "When in doubt: go outside, let them try, read a book."</p>
...
<h2 id="s-measure"><span class="material-symbols-rounded">trending_up</span>How to Know It's Working</h2>
<p>Not tests. Observable behaviors:</p>
<table>
