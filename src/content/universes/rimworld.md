...
phases:
  - phaseId: age-11-13
    tier: recommended
    title: "Colony management + emergent narrative"
    description: "Start with Crashlanded scenario (3 colonists, moderate difficulty). The game teaches itself: assign roles, build shelter, grow food, defend. The magic: stories emerge from system interactions that no one scripted. A colonist's pet dies and they spiral into depression, which reduces productivity, which causes food shortage, which causes another breakdown. This IS feedback loops and emergence made visceral. Discuss after sessions: 'What caused the colony to fail? What was the first domino?'"
    mode: dim
    goals:
      - "Experience emergent narrative arising from interacting systems."
      - "Identify feedback loops in colony dynamics (morale, productivity, resources)."
    cautions: "Contains violence, difficult moral choices, and themes of survival under scarcity. The ethical dilemmas are the point — discuss them, don't avoid them."
  - phaseId: age-14-16
    tier: recommended
    ...
    goals:
      ...
      - "Mod the game: change rules, observe how system behaviour changes."
---
