...
phases:
  - phaseId: age-8-10
    ...
    goals:
      ...
      - "Show how institutions use gifted children when no one draws boundaries for them."
    cautions: "The emotional and manipulative weight of the adults around Ender should be discussed directly."
  - phaseId: age-11-13
    tier: foundational
    ...
    goals:
      ...
      - "Use Speaker to move from victory logic into radical interpretation of the other."
---
